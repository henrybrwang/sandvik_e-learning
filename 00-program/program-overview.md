...
Usage is direct and consumption-based, with no five-hour session or weekly limits; usage is pay as you go, charged to the user's cost center. Users who need a higher usage or spending limit must use the intranet form and receive approval from their cost approver. The spending limit is monthly and should be visible to users in their Claude account.
